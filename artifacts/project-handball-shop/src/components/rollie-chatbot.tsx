...
const ROLLIE_RESPONSES: { keywords: string[]; reply: string }[] = [
  ...
  },
  {
    ...
    reply: "All orders are handcrafted with care — please allow up to 30 days for delivery. Orders over $75 ship free with code SHIRT. We ship domestically and are working on international shipping.",
  },
  {
  ...
  },
  {
    ...
    reply: "You're in luck — use code SHIRT at checkout for free shipping on orders over $75! Follow us on Instagram and TikTok @ProjectHandball to catch future drops and giveaways.",
  },
  {
